...
function arOriginStory(){return '<section class="ar-origin-story section" aria-labelledby="arOriginTitle"><div class="shell"><span class="ar-origin-kicker">WISTIA · AR 축가 제작 이야기</span><h2 id="arOriginTitle">위스티아는 왜<br>AR 축가를 만들었을까요?</h2><p class="ar-origin-lead">직접 노래를 불러 주고 싶지만, 본식에서 실수할까 걱정되는 마음<br>그 마음 때문에 축가를 포기하지 않도록 돕고 싶었습니다</p><figure class="ar-origin-photo">'+img("assets/img/song/solo.webp","녹음을 위해 준비된 마이크",true)+'</figure><div class="ar-origin-ending"><figure>'+img("assets/img/ar-process/02-mixing.webp","녹음한 목소리를 조율하는 장면",true)+'</figure><p>노래를 대신하는 것이 아니라<br><strong>내 목소리로 끝까지 전할 수 있도록</strong><br>한 소절씩 준비하고, 본식에 맞는 AR로 완성합니다</p></div></div></section>'}
