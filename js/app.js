...
function renderHome(requested="role"){
 ...
 const configs={
  role:{number:"",title:"어떤 순간을 남기고 싶으신가요?",description:"준비하시는 서비스를 선택해 주세요",name:"finderRole",items:[["singer","AR 축가 사전녹음",""],["making","축가 녹음 메이킹 필름",""],["couple","듀엣 식전 스토리 필름",""],["proposal","프로포즈 · 답프로포즈",""]]},
