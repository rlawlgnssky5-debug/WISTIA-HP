...
function arPrimaryBenefit(){return '<section class="shell section ar-primary-benefit" aria-labelledby="arPrimaryBenefitTitle"><div class="ar-benefit-copy"><p class="ar-tags"><span class="ar-tag">#한번뿐인본식</span><span class="ar-tag">#내목소리그대로</span></p><h2 id="arPrimaryBenefitTitle"><span class="ar-copy-line1">본식은 라이브로,</span><br><span class="ar-copy-line2-wrap"><strong class="ar-copy-line2">안정감은 AR로</strong><svg class="ar-underline" viewBox="0 0 220 14" preserveAspectRatio="none" aria-hidden="true"><path d="M2 9 C 42 5, 88 12, 128 7 S 198 4, 218 8"/></svg></span></h2><p class="ar-benefit-desc">현장에서 직접 부르는 목소리에 미리 녹음해 보정한 AR을 더해,<br>떨리는 순간에도 자연스럽게 노래를 이어갈 수 있습니다.</p></div><div class="ar-index-wheel" role="group" aria-label="WISTIA AR 축가의 다섯 가지 강점"><div class="ar-index-ring ar-index-ring-1" aria-hidden="true"></div><div class="ar-index-ring ar-index-ring-2" aria-hidden="true"></div><div class="ar-index-center" aria-hidden="true">'+img("assets/img/wistia-ar-index-emblem.png","")+'</div><ul class="ar-index-items">'+AR_INDEX_KEYWORDS.map((k,i)=>'<li><button type="button" class="ar-index-item" data-ar-index="'+i+'" aria-pressed="'+(i===0)+'"><span class="ar-index-dot" aria-hidden="true"></span><span class="ar-index-num">'+k[0]+'</span><span class="ar-index-label">'+k[1]+'</span></button></li>').join("")+'</ul></div></section>'}
