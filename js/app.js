...
function arHookHero(p){return '<section class="ar-hook-hero" aria-labelledby="arHookTitle"><div class="ar-hook-media"><video autoplay muted loop playsinline preload="metadata" poster="assets/img/ar-detail/solo-live-proof.jpg" aria-label="실제 고객의 본식 AR 축가 현장 영상"><source src="'+escapeHtml(p.resultVideo)+'" type="video/mp4">영상을 재생할 수 없는 브라우저입니다</video><span>실제 고객 본식 영상</span></div><div class="ar-hook-copy shell">'+label("1인 AR 축가")+'<h1 id="arHookTitle">떨리는 본식에서도<br><strong>내 목소리가 나를 받쳐줍니다</strong></h1><p>미리 녹음하고 자연스럽게 보정한 내 목소리를 AR로 함께 재생해, 현장에서는 마음에 집중해 노래합니다</p></div></section>'}
