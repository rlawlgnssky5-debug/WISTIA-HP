...
function enhanceMotion(){
 ...
 const nodes=[...document.querySelectorAll(".section-heading,.detail-hero>*:not(.detail-result-card),.detail-result-card,.scene-grid li,.process-list li,.service-row,.situation-group,.picker-grid article,.option-banner,.booking-options>section,.solo-review-copy,.solo-review-visual,.ar-story-meta,.ar-story-copy,.ar-story-image,.wistia-ba-copy,.bap-player,.solo-process-head,.solo-process-slider,.ar-cd-copy,.ar-cd-visual")]
