...
function arPrimaryBenefit(){return '<section class="shell section ar-primary-benefit" aria-labelledby="arPrimaryBenefitTitle"><div class="ar-primary-heading">'+label("가장 큰 장점")+'<h2 id="arPrimaryBenefitTitle">노래를 한 번에 완벽하게 부르는 대신,<br><strong>진심을 끝까지 전할 수 있도록</strong></h2></div><figure class="ar-primary-image">'+img("assets/img/ar-process/01-recording.webp","스튜디오에서 노래를 녹음하는 장면",true)+'<figcaption>한 소절씩 편안하게 녹음</figcaption></figure><div class="ar-primary-copy"><p>스튜디오에서 한 소절씩 녹음하고 음정과 박자를 자연스럽게 다듬은 뒤, 본식에서 편하게 부를 수 있는 목소리 비율로 AR을 완성합니다</p><ol aria-label="AR 축가 이용 흐름"><li><span>01</span><strong>내 목소리 녹음·보정</strong></li><li><span>02</span><strong>본식에 맞는 비율 선택</strong></li><li><span>03</span><strong>현장에서 함께 노래</strong></li></ol><div class="ar-ratio-point"><strong>30 · 50 · 70 · 100%</strong><span>본식에 맞춰 선택하는 AR 속 내 목소리 비율</span></div></div></section>'}
