...
function arHookHero(p){return '<section class="ar-hook-hero" aria-labelledby="arHookTitle"><div class="ar-hook-media">'+img("assets/img/ar-detail/solo-live-proof.jpg","실제 고객의 본식 AR 축가 현장",true).replace('<img ','<img class="ar-hook-fallback" ')+'<video autoplay muted loop playsinline preload="auto" poster="assets/img/ar-detail/solo-live-proof.jpg" aria-label="실제 고객의 본식 AR 축가 현장 영상"><source src="'+escapeHtml(p.resultVideo)+'" type="video/mp4">영상을 재생할 수 없는 브라우저입니다</video><span class="ar-hook-video-source">※ 실제 고객님의 본식 영상입니다</span><button type="button" class="ar-hook-video-control" data-ar-video-toggle aria-label="실제 고객 본식 영상 재생"><span aria-hidden="true">▶</span><b>영상 재생</b></button></div><div class="ar-hook-copy shell">'+label("1인 AR 축가")+'<h1 id="arHookTitle"><span class="hero-line hero-line1">떨리는 본식 무대,</span><br><strong class="hero-line hero-line2">미리 준비한 내 목소리가 함께합니다</strong></h1><p>미리 녹음하고 자연스럽게 보정한 내 목소리를 AR로 함께 재생해,<br>현장에서는 노래와 마음에만 집중할 수 있습니다.</p></div><div class="solo-desktop-cta"><a class="solo-desktop-cta-price" href="#/event/solo"><span class="cta-icon" aria-hidden="true"><svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M12.59 2H4a2 2 0 0 0-2 2v8.59a1 1 0 0 0 .29.7l9 9a1 1 0 0 0 1.42 0l8.6-8.6a1 1 0 0 0 0-1.42l-9-9A1 1 0 0 0 12.59 2Z" stroke="currentColor" stroke-width="1.5"/><circle cx="7.5" cy="7.5" r="1.25" fill="currentColor"/></svg></span><span class="cta-label"><b class="cta-short">PRICE</b><b class="cta-full">이벤트 적용 가격 확인</b></span><span class="cta-arrow" aria-hidden="true">›</span></a><a class="solo-desktop-cta-kakao" href="'+kakao()+'" target="_blank" rel="noopener noreferrer"><span class="cta-icon" aria-hidden="true"><svg width="14" height="14" viewBox="0 0 24 24"><path d="M12 3C6.48 3 2 6.58 2 11c0 2.86 1.9 5.37 4.76 6.8-.16.6-.86 3.1-.9 3.3 0 0-.02.16.08.22a.3.3 0 0 0 .24 0c.32-.05 3.4-2.24 3.96-2.63A13.6 13.6 0 0 0 12 19c5.52 0 10-3.58 10-8s-4.48-8-10-8Z" fill="#FEE500"/></svg></span><span class="cta-label"><b class="cta-short">CONTACT</b><b class="cta-full">맞춤형 1:1 카카오톡 문의</b></span><span class="cta-arrow" aria-hidden="true">›</span></a></div></section>'}
