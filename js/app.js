...
function arPrimaryBenefit(){return '<section class="shell section ar-primary-benefit" aria-labelledby="arPrimaryBenefitTitle"><div class="ar-benefit-copy" data-solo-section-intro><p class="ar-tags" data-solo-kicker>AR BENEFIT</p><h2 id="arPrimaryBenefitTitle" data-solo-title><span class="solo-type-line ar-copy-line1">라이브의 감동은 그대로,</span><span class="solo-type-line ar-copy-emphasis"><span class="ar-copy-emphasis-bg" aria-hidden="true"></span><span class="ar-copy-emphasis-text">AR로 안정감까지 더합니다</span></span></h2><p class="ar-benefit-desc" data-solo-sub><span class="solo-type-line">정교하게 보정한 AR이 목소리를 받쳐주고,</span><span class="solo-type-line">본식에서도 자연스럽게 노래를 이어갑니다.</span></p></div><div class="ar-index-wheel" role="group" aria-label="WISTIA AR 축가의 다섯 가지 강점"><div class="ar-index-ring ar-index-ring-1" aria-hidden="true"></div><div class="ar-index-ring ar-index-ring-2" aria-hidden="true"></div><div class="ar-index-center" aria-hidden="true">'+AR_MIC_ICON+'</div><ul class="ar-index-items">'+AR_INDEX_KEYWORDS.map((k,i)=>'<li><button type="button" class="ar-index-item" data-ar-index="'+i+'" aria-pressed="'+(i===0)+'"><span class="ar-index-dot" aria-hidden="true"></span><span class="ar-index-num">'+k[0]+'</span><span class="ar-index-label">'+k[1]+'</span></button></li>').join("")+'</ul></div></section>'}
...
function arExpertStory(){
 ...
 return '<section class="ar-expert-story section" data-story-carousel aria-labelledby="arExpertStoryTitle"><div class="shell"><header class="ar-story-intro" data-solo-section-intro><p data-solo-kicker>WISTIA · BRAND STORY</p><h2 id="arExpertStoryTitle" data-solo-title><span class="solo-type-line">같은 소스여도,</span><span class="solo-type-line">전문가들과 함께라면 다릅니다.</span></h2></header><div class="ar-story-viewport ar-expert-viewport" tabindex="0"><div class="ar-story-track ar-expert-track" data-expert-track data-index="0">'+EXPERT_CARDS.map((c,i)=>'<article class="ar-story-slide ar-expert-card'+(i===0?' is-active':'')+'" data-story-slide="'+i+'" data-expert-card><header class="ar-story-meta"><b>'+String(i+1).padStart(2,'0')+'</b></header><div class="ar-story-copy"><h3 class="ar-story-role">'+c.keyword+'</h3><p><strong>'+c.sub+'</strong><span>'+c.detail+'</span></p></div><figure class="ar-story-image">'+img(c.image,c.alt)+'</figure></article>').join('')+'</div></div><div class="ar-story-controls"><span class="ar-story-status" data-story-status data-expert-status>01 / '+String(total).padStart(2,'0')+'</span><span class="ar-story-progress" aria-hidden="true"><i></i></span><button type="button" data-expert-prev aria-label="이전 제작 이야기">←</button><button type="button" data-story-next data-expert-next aria-label="다음 제작 이야기">→</button></div></div></section>'
}
...
function soloProcessSlider(){const first=SOLO_STUDIO_PROCESS[0];return '<section class="wistia-process-studio solo-process-section" id="process" data-process-studio aria-labelledby="processStudioTitle">'
 +'<header class="wps-head" data-solo-section-intro><div><p class="wps-kicker" data-solo-kicker>WISTIA · PRODUCTION PROCESS</p><h2 id="processStudioTitle" data-solo-title><span class="solo-type-line">노래가 익숙하지 않아도 괜찮습니다.</span><span class="solo-type-line">완성까지, 함께 만듭니다.</span></h2><p class="wps-sub" data-solo-sub><span class="solo-type-line">상담부터 녹음과 보정, 본식용 AR 전달까지</span><span class="solo-type-line">일곱 단계를 순서대로 확인해 보세요.</span></p></div><div class="wps-counter"><span data-process-current>01</span><i></i><span>07</span></div></header>'
 +'<div class="wps-feature" data-process-feature tabindex="0" role="group" aria-label="작업과정 단계 슬라이더. 좌우 방향키로 단계를 이동할 수 있습니다."><div class="wps-photo"><span class="wps-badge">CURRENT STEP</span>'+img(first.image,first.short,true).replace('<img ','<img data-process-image ')+'</div><article class="wps-content" aria-live="polite" aria-atomic="true"><span class="wps-ghost" data-process-ghost>01</span><p class="wps-step" data-process-eyebrow>'+first.eyebrow+'</p><h3 data-process-title>'+first.title+'</h3><p class="wps-description" data-process-description>'+first.description+'</p><div class="wps-detail" data-process-meta>'+processStudioMeta(first)+'</div><div class="wps-controls"><button type="button" data-process-prev aria-label="이전 단계" disabled>←</button><button type="button" class="is-next" data-process-next aria-label="다음 단계">→</button></div></article></div>'
...
function renderDetail(key,purpose=""){
 ...
 if(key==="solo"){
  app.innerHTML=soloTopCta()+soloPersonTabs(key)+'<div class="solo-detail-scope">'+arHookHero(p)+arPrimaryBenefit()+soloReviewCarousel()+'<div class="solo-editorial-sheet">'+arExpertStory()+'</div>'+wistiaBeforeAfterSection()+arComparisonSection()+soloProcessSlider()+arCdRatioSection()+'<section class="shell section worry-section"><header class="solo-faq-intro" data-solo-section-intro><p data-solo-kicker>FAQ</p><h2 data-solo-title><span class="solo-type-line">자주 묻는 질문을</span><span class="solo-type-line">확인해 보세요.</span></h2><p data-solo-sub><span class="solo-type-line">예약 전 궁금한 내용을 모았습니다.</span><span class="solo-type-line">더 필요한 내용은 편하게 문의해 주세요.</span></p></header>'+faq(p.faq)+'<a class="solo-inline-contact button light" href="'+escapeHtml(kakao())+'" target="_blank" rel="noopener noreferrer">카카오톡으로 상담하기 <span aria-hidden="true">↗</span></a></section>'+footer()+priceBar(key)+'</div>'
  return
 }
