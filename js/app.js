...
function arHookHero(p,key="solo"){const content=AR_DETAIL_CONTENT[key]||AR_DETAIL_CONTENT.solo;return '<section class="ar-hook-hero" aria-labelledby="arHookTitle"><div class="ar-hook-media">'+img(content.poster,content.videoLabel,true).replace('<img ','<img class="ar-hook-fallback" ')+'<video autoplay muted loop playsinline preload="auto" poster="'+escapeHtml(content.poster)+'" aria-label="'+escapeHtml(content.videoLabel)+'"><source src="'+escapeHtml(p.resultVideo)+'" type="video/mp4">영상을 재생할 수 없는 브라우저입니다</video><span class="ar-hook-video-source">※ 실제 고객님의 본식 영상입니다</span><button type="button" class="ar-hook-video-control" data-ar-video-toggle aria-label="영상 재생"><span class="ar-icon-play" aria-hidden="true"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M4 2.5v11l9-5.5-9-5.5Z" fill="currentColor"/></svg></span><span class="ar-icon-pause" aria-hidden="true"><svg width="16" height="16" viewBox="0 0 16 16"><rect x="3" y="2" width="3" height="12" rx="1" fill="currentColor"/><rect x="10" y="2" width="3" height="12" rx="1" fill="currentColor"/></svg></span></button></div><div class="ar-hook-copy shell">'+label(content.kicker)+'<h1 id="arHookTitle"><span class="hero-line hero-line1">'+content.heroLine1+'</span><br><strong class="hero-line hero-line2">'+content.heroLine2+'</strong></h1><p>'+content.heroDescription+'</p></div></section>'}
...
function arPrimaryBenefit(key="solo"){const content=AR_DETAIL_CONTENT[key]||AR_DETAIL_CONTENT.solo;return '<section class="shell section ar-primary-benefit" aria-labelledby="arPrimaryBenefitTitle"><div class="ar-benefit-copy" data-solo-section-intro><p class="ar-tags" data-solo-kicker>AR BENEFIT</p><h2 id="arPrimaryBenefitTitle" data-solo-title><span class="solo-type-line ar-copy-line1">'+content.benefitLine1+'</span><span class="solo-type-line ar-copy-emphasis"><span class="ar-copy-emphasis-bg" aria-hidden="true"></span><span class="ar-copy-emphasis-text">'+content.benefitEmphasis+'</span></span></h2><p class="ar-benefit-desc" data-solo-sub><span class="solo-type-line">'+content.benefitDescription[0]+'</span><span class="solo-type-line">'+content.benefitDescription[1]+'</span></p></div><div class="ar-index-wheel" role="group" aria-label="WISTIA AR 축가의 다섯 가지 강점"><div class="ar-index-ring ar-index-ring-1" aria-hidden="true"></div><div class="ar-index-ring ar-index-ring-2" aria-hidden="true"></div><div class="ar-index-center" aria-hidden="true">'+AR_MIC_ICON+'</div><ul class="ar-index-items">'+content.keywords.map((k,i)=>'<li><button type="button" class="ar-index-item" data-ar-index="'+i+'" aria-pressed="'+(i===0)+'"><span class="ar-index-dot" aria-hidden="true"></span><span class="ar-index-num">'+k[0]+'</span><span class="ar-index-label">'+k[1]+'</span></button></li>').join("")+'</ul></div></section>'}
...
function wistiaBeforeAfterSection(){return '<section class="wistia-ba-section" id="wistiaBeforeAfter" data-before-src="assets/audio/before-after/before.mp3" data-after-src="assets/audio/before-after/after.mp3" aria-labelledby="wistiaBeforeAfterTitle"><div class="wistia-ba-layout"><header class="wistia-ba-copy" data-solo-section-intro><p class="wistia-ba-eyebrow" data-solo-kicker>BEFORE / AFTER</p><h2 id="wistiaBeforeAfterTitle" data-solo-title><span class="solo-type-line">노래를 잘 못해도</span><span class="solo-type-line">괜찮습니다.</span></h2><p data-solo-sub><span class="solo-type-line">녹음 원본이 완벽하지 않아도 괜찮아요.</span><span class="solo-type-line">튠·믹싱으로 목소리와 마음을 선명하게 완성합니다.</span></p></header><div class="bap-player"><div class="bap-tabs" role="group" aria-label="보정 전후 음원 선택"><button class="bap-tab active" type="button" data-mode="before" aria-pressed="true">보정 전</button><button class="bap-switch" type="button" aria-label="보정 전후 전환">⇄</button><button class="bap-tab" type="button" data-mode="after" aria-pressed="false">보정 후</button></div><div class="bap-body"><div class="bap-badge mode-before"><span></span><b>VOCAL 원본</b></div><canvas class="bap-wave" aria-label="오디오 파형. 클릭하여 재생 위치 이동"></canvas><div class="bap-controls"><button class="bap-play mode-before" type="button" aria-label="재생"><span>▶</span></button><div class="bap-time"><b>0:00</b> / <span>0:00</span></div></div><p class="bap-hint">탭을 바꿔도 <b>같은 재생 위치</b>에서 차이를 들을 수 있습니다.</p><p class="bap-note">ⓘ 보정 전과 후의 보컬 소스는 같은 녹음본입니다.</p><p class="bap-error" role="status" hidden>음원을 불러오지 못했습니다. 파일 경로를 확인해 주세요.</p></div></div></div></section>'}
...
function arComparisonSection(){return '<section class="ar-compare section" aria-labelledby="arCompareTitle" data-ar-compare><div class="shell"><header class="ar-compare-intro" data-solo-section-intro><p data-solo-kicker>WHY WISTIA</p><h2 id="arCompareTitle" class="ar-compare-title" data-solo-title><span class="solo-type-line">위스티아는</span><span class="solo-type-line">다릅니다.</span></h2><p class="ar-compare-sub" data-solo-sub><span class="solo-type-line">준비 범위부터 보정과 최종 전달까지,</span><span class="solo-type-line">위스티아의 제작 방식을 비교해 보세요.</span></p></header><div class="ar-compare-table" role="table" aria-label="일반 제작과 WISTIA 비교"><div class="ar-compare-head" role="row"><span role="columnheader">일반 제작</span><strong role="columnheader">WISTIA</strong></div>'+AR_COMPARE_ROWS.map((row,i)=>'<div class="ar-compare-row" data-ar-compare-row role="row" style="--row-i:'+i+'"><span class="ar-compare-general" role="cell">'+row[1]+'</span><strong class="ar-compare-criteria" role="rowheader">'+row[0]+'</strong><span class="ar-compare-wistia" role="cell">'+row[2]+'</span></div>').join("")+'</div><p class="ar-compare-note">제공 범위는 업체와 상품에 따라 달라질 수 있습니다.</p></div></section>'}
...
function soloProcessSlider(key="solo"){const steps=key==="duo"?DUO_STUDIO_PROCESS:SOLO_STUDIO_PROCESS,first=steps[0],description=key==="duo"?["두 사람의 파트와 화음을 맞춘 뒤, 본식용 AR 전달까지","일곱 단계를 순서대로 확인해 보세요."]:["상담부터 녹음과 보정, 본식용 AR 전달까지","일곱 단계를 순서대로 확인해 보세요."];return '<section class="wistia-process-studio solo-process-section" id="process" data-process-studio data-ar-product="'+key+'" aria-labelledby="processStudioTitle">'
 +'<header class="wps-head" data-solo-section-intro><div><p class="wps-kicker" data-solo-kicker>WISTIA · PRODUCTION PROCESS</p><h2 id="processStudioTitle" data-solo-title><span class="solo-type-line">처음부터 끝까지,</span><span class="solo-type-line">맞춤형으로 케어해드립니다.</span></h2><p class="wps-sub" data-solo-sub><span class="solo-type-line">'+description[0]+'</span><span class="solo-type-line">'+description[1]+'</span></p></div><div class="wps-counter" aria-label="현재 프로세스 01 / 07"><span data-process-current>01</span><i></i><span>07</span></div></header>'
...
function soloTopCta(key="solo"){return '<div class="solo-top-cta"><a href="#/event/'+key+'" aria-label="1인·2인 축가 이벤트 가격 확인하기로 이동">1인·2인 축가, 이벤트 가격 확인하기 <b aria-hidden="true">→</b></a></div>'}
...
function arCdRatioSection(){return '<section class="wistia-ar solo-section-reveal" id="arRatioExperience" data-wistia-ar-ratio data-audio-30="'+ratioSource('30')+'" data-audio-50="'+ratioSource('50')+'" data-audio-70="'+ratioSource('70')+'" data-audio-100="'+ratioSource('100')+'" aria-labelledby="wistiaArTitle"><div class="wistia-ar__artboard"><div class="wistia-ar__copy"><p class="wistia-ar__eyebrow">AR RATIO EXPERIENCE</p><h2 class="wistia-ar__title" id="wistiaArTitle">라이브 같은 AR,<br><span>내 목소리에 맞게<br>비율을 골라보세요</span></h2><p class="wistia-ar__description">같은 노래를 30%부터 100%까지 비교해보세요.</p><div class="wistia-ar__player" aria-label="AR 미리듣기 플레이어"><button class="wistia-ar__play" type="button" aria-label="재생" aria-pressed="false"><span class="wistia-ar__play-icon" aria-hidden="true"></span></button><span class="wistia-ar__time"><span data-current-time>0:00</span> / <span data-duration>0:00</span></span><input class="wistia-ar__seek" aria-label="재생 위치" type="range" min="0" max="32" step="0.1" value="0"><button class="wistia-ar__volume" type="button" aria-label="음소거">◖</button><p class="wistia-ar__error" role="status" hidden>음원을 불러오지 못했습니다. 파일 경로를 확인해 주세요.</p></div></div><div class="wistia-ar__disc-stage" aria-label="현재 AR 비율 70%"><img class="wistia-ar__disc" src="assets/img/ar-ratio/wistia-disc.png" alt="" aria-hidden="true"><svg class="wistia-ar__arc" viewBox="0 0 100 100" aria-hidden="true"><path class="wistia-ar__arc-track" d="M70.5 14.5 A41 41 0 0 1 70.5 85.5"></path><g data-arc-ticks></g><circle class="wistia-ar__arc-knob" data-arc-knob r="2.15" cx="88.5" cy="64"></circle><text class="wistia-ar__arc-value" data-arc-value x="94" y="65">70%</text></svg></div><aside class="wistia-ar__ratio" aria-label="AR 비율 선택"><div class="wistia-ar__ratio-line" aria-hidden="true"></div><div class="wistia-ar__ratio-ticks" aria-hidden="true"><div class="wistia-ar__ratio-tick" data-index="3"><span>100</span></div><div class="wistia-ar__ratio-tick" data-index="2"><span>70</span></div><div class="wistia-ar__ratio-tick" data-index="1"><span>50</span></div><div class="wistia-ar__ratio-tick" data-index="0"><span>30</span></div></div><input class="wistia-ar__ratio-input" type="range" min="0" max="3" step="1" value="2" aria-label="AR 비율" aria-valuetext="70%"><output class="wistia-ar__ratio-current">70%</output></aside><audio class="wistia-ar__audio" preload="metadata"></audio></div></section>'}
...
function initSoloProcessSlider(){
 ...
 const steps=root.dataset.arProduct==="duo"?DUO_STUDIO_PROCESS:SOLO_STUDIO_PROCESS
...
function route(){
 ...
 const arDetail=Boolean(detail&&["solo","duo"].includes(key));document.body.dataset.page=home?"home":event?"event":validDetail?"detail":"inner";document.body.classList.toggle("has-price-bar",Boolean(validDetail||ar));document.body.classList.toggle("is-solo-detail",arDetail);document.body.classList.toggle("is-ar-detail",arDetail);
 const soloCta=document.querySelector("#soloDesktopCta");if(soloCta)soloCta.hidden=!arDetail;
